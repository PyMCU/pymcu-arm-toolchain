...
| **[GitHub Releases](https://github.com/PyMCU/pymcu-arm-toolchain/releases)** | Binary wheels with LLVM bundled (~300 MB each) |
...
1. Update `LLVM_VERSION` in `src/pymcu_arm_toolchain/__init__.py`
